...
<div class="container clearfix">
    ...
    <div class="sidebar-content">
        <ul class="sidebar-list">
            <li>
                ...
                <ul class="sub-menu">
                    <li><a href="<?php echo U('Column/column');?>"><i class="icon-font">&#xe008;</i>栏目管理</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo C('admin');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">栏目管理</a><span class="crumb-step">&gt;</span><span>新增</span></div>
        </div>
